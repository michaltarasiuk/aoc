...
assert.strictEqual(trianglesByRows.filter(isValidTriangle).length, 993, "Part 1 failed")
assert.strictEqual(trianglesByCols.filter(isValidTriangle).length, 1849, "Part 2 failed")
